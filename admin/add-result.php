    ...
    if (
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt->errno === 1062) {
                ...
                $message = "This student already has a result for this subject, semester and exam type.";

            } else {

                $message = "Could not add result.";
            }
...
<head>
    ...
    <title>Add Result | College CMS</title>
        ...
        <main class="dashboard-content">
            ...
            <div class="page-heading">
                ...
                <div>
                    ...
                    <p>
                        Add student examination result.
                    </p>
